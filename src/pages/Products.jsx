...
const Products = () => {
  ...
  const getProductList = async () => {
    let url = `https://my-json-server.typicode.com/chaerin-kim/shoptest/products/${id}`;
    let response = await fetch(url);
    let data = await response.json();
    setProducts(data);

    let url2 = `https://my-json-server.typicode.com/chaerin-kim/shoptest/products?category=${data.category}`;
